...
get-wmiObject -class Win32_Processor | fl Description, MaxClockSpeed, NumberOfCores, @{n="L1CacheSize";e={switch($_.L1CacheSize){$null{$state="data unavailable."}};$state}}, L2CacheSize, L3CacheSize
}
